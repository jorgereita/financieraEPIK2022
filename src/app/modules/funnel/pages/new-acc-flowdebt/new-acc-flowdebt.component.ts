...
@Component({
  selector: 'app-new-acc-flowdebt',
  templateUrl: './new-acc-flowdebt.component.html',
  styleUrls: ['./new-acc-flowdebt.component.scss']
})
export class NewAccFlowdebtComponent implements OnInit {
  ...
  sendDataPop() {
    ...
    const formData = {
      ...
      "IdDatoCuenta": 0,
      "CuentaDiferenteRecaudo": this.additionalDataForm.value.checkDiffDeb?true:false,
      "ObjDatosDesembolso": {
